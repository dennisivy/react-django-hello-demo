    ...
    <div className="App">
      <header className="App-header">
        <div class="wrapper">
          ...
          <p>Want to see a Django-React ToDo app with a tutorial? Let me know by leaving a comment on youtube or facebook.</p>
          <a
            className="App-link"
            href="https://github.com/divanov11/react-django-hello-demo"
            target="_blank"
          ...
          <a
            className="App-link"
            href="https://www.facebook.com/dennis.ivanov.733"
            target="_blank"
            rel="noopener noreferrer"
          >
            Facebook Profile
